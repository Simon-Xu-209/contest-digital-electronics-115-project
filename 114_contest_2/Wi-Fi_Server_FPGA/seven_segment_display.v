	...
	if (!rst_n) begin
		...
		case(current_sys_mode)
			...
			MODE_INITIAL: begin
				...
				seg_com_data[6] <= {1'b0, text[27]}; // 'R'
				seg_com_data[5] <= {1'b0, text[14]}; // 'E'
				seg_com_data[4] <= {1'b0, text[10]}; // 'A'
				seg_com_data[3] <= {1'b0, text[13]}; // 'D'
				seg_com_data[2] <= {1'b0, text[34]}; // 'Y'
			...
			MODE_IDLE: begin
				seg_com_data[7] <= {1'b0, text[12]}; // 'C'
				seg_com_data[6] <= {1'b0, text[21]}; // 'L'
				seg_com_data[5] <= {1'b0, text[29]}; // 'T'
				seg_com_data[4] <= {1'b0, text[33]}; // 'x'
				seg_com_data[3] <= {1'b1, text[36]}; // '.'
				seg_com_data[2] <= {1'b0, text[0]};  // '0'
			...
			MODE_EDIT: begin
				...
				seg_com_data[6] <= {1'b0, text[21]}; // 'L'
				seg_com_data[5] <= {1'b0, text[29]}; // 'T'
				seg_com_data[4] <= {1'b0, text[switch_8bit[4:2]]}; // '0' ~ '7'
				seg_com_data[3] <= {1'b1, text[36]}; // '.'
				seg_com_data[2] <= {1'b0, text[0]};  // '0'
				seg_com_data[1] <= {1'b0, text[0]};  // '0'
				seg_com_data[0] <= {1'b0, text[0]};  // '0'
