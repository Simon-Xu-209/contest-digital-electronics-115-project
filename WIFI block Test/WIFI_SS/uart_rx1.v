module uart_rx1(
	...
	input rxd_in,
	output reg [7:0] rxd,
	output reg RECEIVE_END // 1=收完一筆指令 0=沒收完一筆指令
);
...
//產生rxd_in下緣
assign rxd_neg_w = (~rx_reg2) & rx_reg3;// ~0*1=1
...
assign bps_rx_clk =(cnt_baud==(div_num-1)>>1'd1)? 1'd1 : 1'd0; // cnt_baud==(div_num-1) ? 1:0
